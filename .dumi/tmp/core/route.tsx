...
'docs/getting-started.zh-CN': React.lazy(() => import(/* webpackChunkName: "docs__getting-started.zh-CN.md" */'/workspace/AoneUI/docs/getting-started.zh-CN.md')),
'docs/getting-started': React.lazy(() => import(/* webpackChunkName: "docs__getting-started.md" */'/workspace/AoneUI/docs/getting-started.md')),
'docs/index.zh-CN': React.lazy(() => import(/* webpackChunkName: "docs__index.zh-CN.md" */'/workspace/AoneUI/docs/index.zh-CN.md')),
